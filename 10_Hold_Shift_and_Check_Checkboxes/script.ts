...
let lastChecked: null | HTMLInputElement = null; // 최근 클릭한 input 저장

// 토글을 이용한 방식
function handleCheck(this: HTMLInputElement, e: MouseEvent) {
  // console.log(e);
  ...
  lastChecked = this as HTMLInputElement;
}

// 순서를 직접 받아 처리하는 방식
function handleCheck2(this: HTMLInputElement, e: MouseEvent) {
  // shift 키를 누르고 있으며, 지금 항목을 체크한 경우
